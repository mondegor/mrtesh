...
- `curl -L -o mrtesh.zip https://github.com/mondegor/mrtesh/archive/refs/tags/v0.3.4.zip`
- `unzip mrtesh.zip && rm mrtesh.zip && mv mrtesh-0.3.4 mrtesh && chmod +x ./mrtesh/test.sh`
