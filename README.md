...
- `curl -L -o mrtesh.zip https://github.com/mondegor/mrtesh/archive/refs/tags/vv0.3.4.zip`
- `unzip mrtesh.zip && rm mrtesh.zip && mv mrtesh-v0.3.4 mrtesh && chmod +x ./mrtesh/test.sh`
